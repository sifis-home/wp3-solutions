...
public class InteropParametersOld {
	...
	public static final byte[] RIKARD_ENTITY_1_KID = StringUtil.hex2ByteArray("A001");
	public static final byte[] RIKARD_ENTITY_2_KID = StringUtil.hex2ByteArray("A200");
	public static final byte[] RIKARD_ENTITY_3_KID = StringUtil.hex2ByteArray("A203");

	public static final byte[] JS_ENTITY_1_KID = StringUtil.hex2ByteArray("E1");
	public static final byte[] JS_ENTITY_2_KID = StringUtil.hex2ByteArray("E2");
	public static final byte[] JS_ENTITY_3_KID = StringUtil.hex2ByteArray("E3");

	/* General context settings */

	public static final byte[] MASTER_SECRET_EDDSA = Bytes.EMPTY;
	public static final byte[] MASTER_SECRET_ECDSA = StringUtil.hex2ByteArray("0102030405060708090a0b0c0d0e0f10");

	public static final byte[] MASTER_SALT_EDDSA = Bytes.EMPTY;
	public static final byte[] MASTER_SALT_ECDSA = StringUtil.hex2ByteArray("9e7ca92223786340");

	public static final byte[] GROUP_ID_EDDSA = Bytes.EMPTY;
	public static final byte[] GROUP_ID_ECDSA = StringUtil.hex2ByteArray("0A0B0C");
