...
/**
 * EDHOC server using Authentication method 0, and using the Optimized request.
 *
 */
public class Phase3Server extends CoapServer {
	...
	// message_2 or as ID_CRED_I in EDHOC message_3,
	// i.e., for this peer to indicate its own authentication credential to the
	// other peer. Possible values: ID_CRED_TYPE_KID ; ID_CRED_TYPE_CWT ;
	// ID_CRED_TYPE_CCS ; ID_CRED_TYPE_X5T ; ID_CRED_TYPE_X5U ;
	...
	public static void main(String[] args) {
		...
		System.out.println("Phase3Server starting on port: " + COAP_PORT);
