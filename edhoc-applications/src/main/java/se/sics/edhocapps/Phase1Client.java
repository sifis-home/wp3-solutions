...
/**
 * EDHOC client using Authentication method 0, and not using the Optimized
 * request.
 *
 */
@ClientEndpoint
public class Phase1Client {
	...
	// completion private static final boolean POST_EDHOC_EXCHANGE = true;
	...
	public static void main(String args[]) {
		...
		System.out.println("Starting Phase1Client...");
