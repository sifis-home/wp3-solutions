 ...
 *
 * <p>
 * The way in which a test is run is controlled by properties which are
 * typically supplied in property file. A
 * {@link org.eclipse.paho.client.mqttv3.test.properties.TestProperties
 * TestProperties} class provides default values and getter methods to supported
 * properties. When the properties have been loaded, the framework logs the
 * non-default values
 * 
 * <p>
 ...
 * <ul>
 * <li>Get filename from system property <code>TEST_PROPERTY_FILENAME</code>
 * with a default value of <code>test.properties</code>
 ...
 * <li>Load properties using this filename as a resource in the same package as
 * the TestProperties class
 * </ul>
 * </ul>
 * 
 * <p>
 * A property loaded from a file is overridden by a system property of the same
 * name.
 * 
 * <p>
 * A property file loaded as a resource may be located in any eclipse project on
 * the runtime classpath.
 * <ul>
 * <li>Note: If you intend to run a testcase to run against a server but the the
 * property file is in a server eclipse project, remember to set the "project"
 * setting on the eclipse run configuration to make eclipse add the server
 * eclipse project to the runtime classpath, otherwise the testcase will load
...
public class TestProperties {
	 ...
	 * <p>
	 * The default value is <code>tcp://&lt;localhost&gt;:1883</code>> where
	 * <code>&lt;localhost&gt;</code> is expressed as a IPv4 dotted decimal
	 * value
	 */
	 ...
	 * <ul>
	 * <li>{@link org.eclipse.paho.client.mqttv3.test.client.pahoJava.MqttClientFactoryPahoJava
	 * PahaJava} (This is the default)
	 * </ul>
	 */
	...
	/**
	 * This is equivalent to class.getResourceAsStream but allows us to report
	 * the URL location
	 * 
	 * @param filename
	 * @return stream
	...
	/**
	 * @return The server URI which may be set in the constructor of an
	 *         MqttClient
	...
	/**
	 * @return The WebSocket Server URI which may be set in the constructor of
	 *         an MqttClient
	 * @throws URISyntaxException
	 */
	...
	/**
	 * Returns a list of URIs which may set in the MQTTConnectOptions for an HA
	 * testcase
	 * 
	 * @return value
	 * @throws URISyntaxException
